...
//
const { NameError, AgeError1, AgeError2, AgeError3, MailError, PhoneError, FailedSubmit } = composeStories(stories)
// ____________________________________________________________
//
